        ...
        <div className="max-w-[900px] mx-auto">
          <div className="prose prose-lg max-w-none">
            <p className="text-[18px] text-gray-600 leading-relaxed mb-8">
              These Terms govern your use of services provided by Drug Drop Rx.
              By engaging our services, you agree to these Terms.
            </p>

            <div className="space-y-10">
              <div>
                <h2 className="text-[32px] font-bold text-[#243b8f] mb-4">
                  1. Services
                </h2>
                <p className="text-[16px] text-gray-600 leading-relaxed mb-4">
                  Drug Drop Rx provides:
                </p>
                <ul className="space-y-3 ml-6">
                  <li className="text-[16px] text-gray-600 leading-relaxed">
              ...
              <div>
                ...
                <ul className="space-y-3 ml-6">
                  ...
                  <li className="text-[16px] text-gray-600 leading-relaxed">
                    Supply lawful content and data
                  </li>
                  <li className="text-[16px] text-gray-600 leading-relaxed">
                    Pay invoices on time as per agreed terms
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3 ml-6">
                  <li className="text-[16px] text-gray-600 leading-relaxed">
                    Invoices must be paid as per agreed milestones
                  </li>
                  <li className="text-[16px] text-gray-600 leading-relaxed">
              ...
              <div>
                ...
                <ul className="space-y-3 ml-6">
                  <li className="text-[16px] text-gray-600 leading-relaxed">
                    Upon full payment, client receives rights to final
                    deliverables
                  </li>
                  <li className="text-[16px] text-gray-600 leading-relaxed">
                    Drug Drop Rx retains rights to pre-existing tools,
              ...
              <div>
                ...
                <div className="bg-slate-50 border border-slate-200 rounded-lg p-8 mt-6">
                  <h3 className="text-[20px] font-bold text-[#243b8f] mb-4">
                    Drug Drop Rx
                  </h3>
                  <div className="space-y-2">
                    ...
                    <p className="text-[16px] text-gray-600 leading-relaxed">
                      ...
                      <br />
                      [Your registered Indian company address]
                    </p>
                  </div>
                </div>
              </div>
